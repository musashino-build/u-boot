...
void qca955x_pll_init(void)
{
	...
	/* init_ahb_pll (720_600_300) */
	writel(CPU_DDR_CLOCK_CONTROL_AHBCLK_FROM_DDRPLL_MASK |
	       /* use CPU PLL for DDR */
	       /* use DDR PLL for CPU */
	       FIELD_PREP(CPU_DDR_CLOCK_CONTROL_AHB_POST_DIV_MASK, 0x1) |
